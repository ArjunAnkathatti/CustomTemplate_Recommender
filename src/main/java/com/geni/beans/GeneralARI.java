...
public class GeneralARI {
	...
	private String appPreferredDimension;
	...
	public String getAppPreferredDimension() {
		return appPreferredDimension;
	}
	public void setAppPreferredDimension(String appPreferredDimension) {
		this.appPreferredDimension = appPreferredDimension;
	}
